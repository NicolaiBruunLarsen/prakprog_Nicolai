...
void write_wavefunction(double E, double rmin, double rmax, double acc, double eps){
	...
	pp::vector y0{rmin-rmin*rmin,1-2*rmin};
	auto [rs,ys] = pp::driver(F,rmin,rmax,y0,0.05,acc,eps);
	std::ofstream out("out.wavefunction.txt");
