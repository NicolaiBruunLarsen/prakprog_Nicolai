...
#include <algorithm> // use max in approx(double, double)

namespace pp {

vector::vector(int n) : data(n) {}
vector::vector(std::initializer_list<double> init) : data(init) {} // setting up the vector with an initializer list, e.g. pp::vector v = {1.0, 2.0, 3.0};
